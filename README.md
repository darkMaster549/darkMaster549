...
local Rodgie = {
    ...
    focus     = { "Lua", "VM Design", "Obfuscation", "Dev" },
    currently = "Building a Lua VM obfuscator from scratch",
    motto     = "if they can read it, it's not done yet"
}
```

---

> *"Obfuscation isn't hiding bad code — it's protecting good code."*

---

⭐ *feel free to star anything useful*
